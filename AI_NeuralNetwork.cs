...
{
    class AI_NeuralNetwork
    {
        private readonly double _learningRate;
        private Matrix _weightHiddenOutput;
        private Matrix _weightInputHidden;

        public AI_NeuralNetwork(int numberOfInputNodes, int numberOfHiddenNodes, int numberOfOutputNodes, double learningRate)
        {
        ...
        {
            _weightHiddenOutput.Initialize(() => Model.Random.NextDouble() - 0.5);
            _weightInputHidden.Initialize(() => Model.Random.NextDouble() - 0.5);
        }
